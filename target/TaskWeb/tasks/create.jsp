...
<body>
  ...
  <form method="post" action="<%= request.getContextPath() %>/tasks/create">
    ...
    <input name="title" value="<c:out value='${v_title}'/>">
    ...
    <textarea name="description"><c:out value="${v_description}"/></textarea>
    <br><br>

    <label>Due date</label><br>
    <input name="due_date" placeholder="YYYY-MM-DD" value="<c:out value='${v_due_date}'/>">
    ...
    <label>
      <input type="checkbox" name="is_done" <c:if test="${v_is_done}">checked</c:if>>
      Done
    </label>
    <br><br>
