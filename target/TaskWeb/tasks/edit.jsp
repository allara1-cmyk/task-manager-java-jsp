...
<body>
      ...
      <form method="post" action="<%= request.getContextPath() %>/tasks/update">
        ...
        <div class="form-group">
          ...
          <textarea 
            id="description" 
            name="description" 
            placeholder="Add more details about your task..."><c:out value="${task.description}"/></textarea>
        ...
        <div class="form-group">
          <label class="checkbox-wrapper" id="checkboxWrapper">
            ...
            <span class="checkbox-label">
              <span id="checkboxText">Mark as completed</span>
            </span>
          </label>
        </div>
  ...
  <script>
    ...
    // Manejar el estilo del checkbox
    ...
    function updateCheckboxStyle() {
      if (checkbox.checked) {
        ...
        checkboxText.innerHTML = '<span class="material-icons" style="font-size: 16px; vertical-align: middle;">check_circle</span> Task completed';
      } else {
        checkboxWrapper.classList.remove('checked');
        checkboxText.textContent = 'Mark as completed';
      }
    }
